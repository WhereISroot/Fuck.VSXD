...
### Для Windows(обещаю, еще пару тройку тестов и я доделаю)

```batch
# Установка зависимостей
pip install -r requirements.txt - not working now

# Запуск программы
python schematic_converter.py - not working now
```
### Для macOS (На ваш страх и риск)
...
# Windows (пока не сделал бинарник, терпите XD )
...
Э.. оставлю вам криптокошелек в usdt, можете на покушать кинуть, а так все для народа!
